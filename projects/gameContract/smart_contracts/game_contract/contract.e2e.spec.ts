...
import { GameContractFactory } from '../artifacts/game_contract/GameContractClient'
...
describe('GameContract contract', () => {
  ...
  const deploy = async (account: Address) => {
    const factory = localnet.algorand.client.getTypedAppFactory(GameContractFactory, {
